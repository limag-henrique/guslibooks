            ...
            <div className="max-w-7xl mx-auto px-4 py-8 md:py-12 flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="flex flex-col items-center md:items-start gap-2">
                    ...
                    <p className="text-sm text-black">
                        &copy; {new Date().getFullYear()} Gusli Books
                    </p>
                </div>

                <div className="flex gap-4 text-sm text-black">
                    <Link to="/politica-de-privacidade" className="hover:text-black transition-colors">Política de Privacidade</Link>
                    <Link to="/termos-de-servico" className="hover:text-black transition-colors">Termos de Serviço</Link>
